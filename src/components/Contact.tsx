      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ¿Tienes preguntas sobre JUMAVI o quieres unirte a nuestro
            movimiento? Estamos aquí para acompañarte en tu camino vocacional.
          </p>
        </div>
            ...
            <div className="bg-yellow-50 rounded-2xl p-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-blue-900 mb-4">
                  ¿Primera vez en JUMAVI?
                </h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Si es tu primera vez conociendo sobre nosotros, te invitamos a
                  explorar nuestro sitio web y conocer más sobre nuestra
                  historia, misión y forma de vida.
                </p>

...
import { Heart, Mail, Phone, MapPin, Facebook, Instagram, Youtube, Twitter, Globe, ArrowUp } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">Juventud Mariana Vicentina</p>
                </div>
              </div>
              <p className="text-blue-100 leading-relaxed mb-6">
                Movimiento juvenil internacional que vive el carisma de San Vicente de Paúl 
                y Santa Luisa de Marillac, presente en 78 países con más de 30,000 jóvenes comprometidos.
              </p>
        ...
        <div className="border-t border-blue-800 py-8">
          <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-bold text-blue-900 mb-4">Mantente Conectado</h3>
            <p className="text-blue-800 mb-6 max-w-2xl mx-auto">
              Recibe nuestras noticias, eventos y oportunidades de participación directamente en tu correo.
            </p>
        ...
        <div className="border-t border-blue-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-blue-200 text-sm mb-4 md:mb-0">
              <p>&copy; 2024 Juventud Mariana Vicentina. Todos los derechos reservados.</p>
              <p className="mt-1">Fundada en 1830 • Presente en 78 países • Más de 30,000 jóvenes</p>
            </div>
        ...
        <div className="border-t border-blue-800 py-8 text-center">
          ...
          <cite className="text-yellow-400 font-semibold mt-2 block">San Vicente de Paúl</cite>
        </div>
      </div>
    </footer>
  );

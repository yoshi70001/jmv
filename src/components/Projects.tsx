...
import { Camera, Heart, Users, BookOpen, Utensils, GraduationCap, Home, Stethoscope, Filter } from 'lucide-react';
  ...
  const projects = [
    {
      ...
      category: 'social',
      location: 'Lima, Perú',
      description: 'Preparación y distribución de alimentos calientes para familias en situación de vulnerabilidad en los pueblos jóvenes de Lima.',
    ...
    },
    {
      ...
      description: 'Programa integral de reinserción social para jóvenes en situación de riesgo, ofreciendo formación técnica y acompañamiento personal.',
    ...
    },
    {
      ...
      description: 'Espacios de refuerzo académico y acompañamiento pedagógico para niños y adolescentes de barrios periféricos.',
      impact: '200 niños con mejores calificaciones',
      image: 'https://images.pexels.com/photos/8617838/pexels-photo-8617838.jpeg?auto=compress&cs=tinysrgb&w=800',
      year: '2024'
    },
    {
      id: 4,
      ...
      category: 'health',
      location: 'Cusco, Perú',
      description: 'Atención médica básica gratuita en comunidades rurales andinas con difícil acceso a servicios de salud.',
    ...
    },
    {
      ...
      description: 'Alimentación diaria para niños en edad escolar de familias de escasos recursos en zonas fronterizas.',
    ...
    },
    {
      ...
      description: 'Construcción y mejoramiento de viviendas para familias en situación de vulnerabilidad habitacional.',
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-blue-900 mb-6">Proyectos y Actividades</h1>
          <p className="text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Conoce algunos de los proyectos que nuestros jóvenes desarrollan alrededor del mundo, 
            transformando realidades de pobreza y exclusión social.
          </p>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="bg-yellow-50 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="font-semibold text-yellow-800">Impacto</span>
                  </div>
                  <p className="text-yellow-700 font-medium">{project.impact}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-900 to-purple-900 rounded-2xl p-8 lg:p-12 text-white">
          <h2 className="text-3xl font-bold text-center mb-12">Impacto Global de Nuestros Proyectos</h2>
        ...
        <div className="mt-16 text-center">
          <div className="bg-yellow-50 rounded-2xl p-8 lg:p-12">
            <h2 className="text-3xl font-bold text-blue-900 mb-6">¡Sé Parte del Cambio!</h2>
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Cada proyecto nace del corazón de jóvenes comprometidos. 
              Únete a nosotros y ayuda a transformar vidas.
            </p>
